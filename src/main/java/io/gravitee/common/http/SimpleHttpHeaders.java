 ...
 */
public class SimpleHttpHeaders implements MultiValueMap<String, String> {
    ...
    public SimpleHttpHeaders(int initialCapacity) {
        this.headers = new LinkedCaseInsensitiveMap<>(initialCapacity);
    }

    public SimpleHttpHeaders(SimpleHttpHeaders httpHeaders) {
